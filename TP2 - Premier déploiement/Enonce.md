...
5. ATTENTION nous travaillerons uniquement dans la region `France Central` dans **toute** **cette** **formation**
...
- Créez un dossier nommé tp-2

- Copier les deux fichiers main.tf et provider.tf dans votre répertoire
    
- examiner les deux fichiers et remplir les champs vides 
...
- Appliquez les modifications.
  ...
  Consultez le fichier terraform.tfstate pour observer l’état des ressources.

  modifier le tag par :

```
  tags = {
      Name = "vm-<votre prénom>"
  }
