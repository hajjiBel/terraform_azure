...
6. **Conteneur Blob**: Vous devez également créer un compte de stockage appelé storage-account-azure-votreprenom-training de la classe de stockage general purpose v2 et un conteneur blob appelé "training-container" avec un type d'accès privée.Attention , votre nom de compte de stockage doit être unique
